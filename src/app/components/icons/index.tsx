...
export const IconChevronRight: React.FC<IconProps> = ({size = 16, color = 'currentColor'}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} className="bi bi-chevron-compact-right" viewBox="0 0 16 16">
...
export const IconChevronLeft: React.FC<IconProps> = ({size = 16, color = 'currentColor'}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} className="bi bi-chevron-compact-left" viewBox="0 0 16 16">
